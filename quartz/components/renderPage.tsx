...
export function pageResources(
  ...
  resources.js.push({
    src: `${joinSegments(baseDir, "static/background-animation.js")}?v=4`,
  ...
  const doc = (
    <html lang={lang} dir={direction}>
      ...
      <body data-slug={slug} data-basepath={basePath}>
        <div id="particles-background" aria-hidden="true" data-persist="">
          <canvas data-persist=""></canvas>
        </div>
        <button
          class="particle-toggle global-particle-toggle"
          type="button"
          aria-label="Pause particles"
          aria-pressed="false"
          title="Pause particles"
          data-persist=""
        >
          <svg class="particle-toggle-icon" viewBox="0 0 24 24" aria-hidden="true">
            <path
              class="particle-toggle-pause"
              d="M7 3v18M17 3v18"
              fill="none"
              stroke="currentColor"
              stroke-width="2.4"
            ...
            />
            <path class="particle-toggle-play" d="M6 2v20l16-10z" fill="currentColor" />
          </svg>
        </button>
